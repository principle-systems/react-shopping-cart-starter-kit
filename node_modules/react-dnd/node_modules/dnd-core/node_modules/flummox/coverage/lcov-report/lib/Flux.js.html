...
<html lang="en">
<head>
    <title>Code coverage report for lib/Flux.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/Flux.js</span></h1>
    <h2>
        
        Statements: <span class="metric">95.04% <small>(134 / 141)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">73.97% <small>(54 / 73)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; Flux.js</div>
</div>
<div class="body">
...
&nbsp;
var _applyConstructor = function (Constructor, args) { var instance = Object.create(Constructor.prototype); var result = Constructor.apply(instance, args); return result != null &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >typeof result == "object" </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >typeof result == "function")</span> ? <span class="branch-0 cbranch-no" title="branch not covered" >result </span>: instance; };
&nbsp;
...
&nbsp;
    ...
    createActions: {
      value: function createActions(key, _Actions) {
        for (var _len = arguments.length, constructorArgs = Array(_len &gt; 2 ? _len - 2 : 0), _key = 2; _key &lt; _len; _key++) {
<span class="cstat-no" title="statement not covered" >          constructorArgs[_key - 2] = arguments[_key];</span>
        }
&nbsp;
...
&nbsp;
    ...
    waitFor: {
      value: function waitFor(tokensOrStores) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!Array.isArray(tokensOrStores)) tokensOrStores = [tokensOrStores];
&nbsp;
        var ensureIsToken = function (tokenOrStore) {
          return tokenOrStore instanceof Store ? tokenOrStore._token : <span class="branch-1 cbranch-no" title="branch not covered" >tokenOrStore;</span>
        };
&nbsp;
    ...
    removeAllStoreListeners: {
      value: function removeAllStoreListeners(event) {
        for (var key in this._stores) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._stores.hasOwnProperty(key)) <span class="cstat-no" title="statement not covered" >continue;</span>
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Mar 11 2015 10:46:29 GMT-0400 (EDT)</div>
</div>
